...
str = str.replace(
/\[\[([^[]*?[.]mp3)\]\]/g,
'<audio class="audio_with_controls autoplay" src="$1" preload controls controlslist="nodownload" style="vertical-align: middle;margin-left:40px;" onclick="this.play()"/>'
);
} else {
str = str.replace(
/\[\[([^[]*?[.]mp3)\]\]/g,
'<audio class="audio_with_controls autoplay" src="$1" preload controls controlslist="nodownload" style="vertical-align: middle;margin-left:40px;"/>'
);
}
str = str.replace(
/\{\{([^\}]*?)\}\}/g,
...
var seed = 'c4898ca5452d97a1f499e771ef775ab31cc95d4a';
this.dummy = true;
